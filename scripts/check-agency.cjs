...
const result=cp.spawnSync(process.execPath,[compiler,'--noEmit','--strict','--skipLibCheck','--target','es2022','--module','nodenext',
  ...
  'tests/agency/adaptive-trip.test.ts','tests/agency/build-guides.test.ts','scripts/agency-status.ts','tests/agency/hierarchy.test.ts','tests/agency/development-retry.test.ts','src/agency/live-adapter.ts','src/action-outcome.ts','agents/advanced/src/agency-bridge.ts','src/agency/journal-recovery.ts','agents/advanced/src/startup.ts','agents/advanced/src/live-navigation.ts','agents/advanced/src/collision-startup.ts'],{stdio:'inherit'});
