...
const files=['src/agency/build-guides.ts','src/agency/build-rules.ts','src/training/guide-leads.ts','src/training/discovery.ts','src/training/catalog.ts','scripts/agency-status.ts','src/agency/development.ts','src/agency/step-retry.ts','src/agent.ts','src/agency/live-adapter.ts','src/agency/world-model.ts','src/agency/director.ts','src/action-outcome.ts',
...
const result=cp.spawnSync(process.execPath,[compiler,'--noEmit','--strict','--skipLibCheck','--target','es2022','--module','nodenext',
  ...
  'tests/agency/build-guides.test.ts','scripts/agency-status.ts','tests/agency/hierarchy.test.ts','tests/agency/development-retry.test.ts','src/agency/live-adapter.ts','src/action-outcome.ts','agents/advanced/src/agency-bridge.ts','src/agency/journal-recovery.ts','agents/advanced/src/startup.ts','agents/advanced/src/live-navigation.ts','agents/advanced/src/collision-startup.ts'],{stdio:'inherit'});
